...
{
    "name": "armaanvipddos Codespace",
    "image": "mcr.microsoft.com/vscode/devcontainers/python:3.8",
    "postStartCommand": "echo '*'; echo '*         @Luci_Magic Bot Running      *'; echo '*'; python /workspaces/armaanvipddos/Luci.pu")",
    "postCreateCommand": "pip install pymongo python-telegram-bot pyTelegramBotAPI certifi && chmod +x /workspaces/armaanvipddos/*",
    "customizations": {
        "vscode": {
            "settings": {
